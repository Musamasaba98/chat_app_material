     ...
     sx={{display:{xs:"none",sm:"block"}}}>
      <Box position="fixed" width={300}>
        ...
        <ImageList cols={3} rowHeight={50} gap={5} >
          ...
          <ImageListItem>
            <img src='https://images.unsplash.com/photo-1567306301408-9b74779a11af' alt='tomato basil' />
          </ImageListItem>
          <ImageListItem>
            <img src='https://images.unsplash.com/photo-1471357674240-e1a485acb3e1' alt='sea star' />
          </ImageListItem>
          <ImageListItem>
            <img src='https://images.unsplash.com/photo-1589118949245-7d38baf380d6' alt='bike' />
          </ImageListItem>
        </ImageList>
